    ...
    <div class="content">
      <div class="pet-profile-full">
        <div class="fixed-container">
          <img
            src="@/assets/images/PetProfileMockUp/ProfileImage.jpg"
            alt="ProfileImage"
            class="profile-img"
          />
          ...
          <div class="treat-acknowledgement">
            ...
            <p v-if="treatStatus === 'rejected'" class="treat-acknowledgement-text">
              Your treat was rejected... 😔
            </p>
            <p v-if="treatStatus === 'accepted'" class="treat-acknowledgement-text">
        ...
        <div class="scrollable-container">
          ...
          <div
            v-if="
              ...
              (petData.petLifestyleTraining && petData.petLifestyleTraining.length)
            "
            class="info"
          >
            <div class="subheader">
            ...
            <div
              v-if="
                petData.petLifestyleActivity && petData.petLifestyleActivity.length
              "
              class="values"
            >
          ...
          <div class="info">
            ...
            <div v-if="petData.petVax && petData.petVax.length" class="values">
              ...
              <p class="value" v-for="(item, index) in petData.petVax" :key="index">
                {{ item }}
              </p>
            </div>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      async goToReport() {
        ...
        console.log("petprofile petListingId:", localStorage.getItem("currentPetId"));
        console.log("petprofile userId:", localStorage.getItem("currentUserId"))
        // Navigate to the Report page
        this.$router.push({ name: "Report" });
        console.log("Navigating to report page:", this.petListingId, this.adopterId);
      }
    },
  };
  </script>
